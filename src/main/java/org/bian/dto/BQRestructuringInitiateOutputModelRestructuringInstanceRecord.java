...
public class BQRestructuringInitiateOutputModelRestructuringInstanceRecord   {
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Definition of issue to resolve and the restructuring solution with associated changes to the credit facility terms and the assessed impact 
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: Calculated loss/costs of restructuring the credit facility 
